...
const VisionSection: React.FC = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      id="vision"
      className="section-pinned bg-vaulta-dark z-[80]"
    >
      {/* Background Image */}
      <div 
        ref={bgRef}
      ...
      >
        <img 
          src="/images/africa_phone_bg.jpg" 
          alt="African landscape with phone"
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        ...
        <div 
          ...
          style={{ opacity: 0 }}
        >
          <div className="px-4 py-2 rounded-full bg-vaulta-teal/20 border border-vaulta-teal/30 backdrop-blur-sm float-animation">
            <div className="flex items-center gap-2">
              <Lock className="w-4 h-4 text-vaulta-teal" />
              <span className="text-vaulta-teal text-sm font-medium">Privacy-first</span>
            </div>
          </div>
        </div>
