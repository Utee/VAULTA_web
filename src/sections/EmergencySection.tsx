...
const EmergencySection: React.FC = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      id="emergency"
      className="section-pinned bg-vaulta-dark z-[60]"
    >
      {/* Background Image */}
      <div 
        ref={bgRef}
      ...
      >
        <img 
          src="/images/transit_phone_bg.jpg" 
          alt="Transit with phone"
      ...
      <div className="relative z-10 w-full h-full flex items-center justify-center">
        ...
        <div 
          ...
          style={{ opacity: 0 }}
        >
          <DeviceMockup screen="emergency" />
        </div>

        {/* Accessibility Badge */}
        <div 
          ref={badgeRef}
          className="absolute left-[60vw] top-[46%] hidden lg:block"
          style={{ opacity: 0 }}
        >
          <div className="px-4 py-2 rounded-full bg-white/[0.08] border border-white/10 backdrop-blur-sm float-animation">
            <div className="flex items-center gap-2">
              <Unlock className="w-4 h-4 text-vaulta-teal" />
              <span className="text-vaulta-text text-sm font-medium">Accessible without unlock</span>
            </div>
          </div>
        </div>
